...
public class FormPesananDalamProses extends Form{
    ...
    private JPanel setButton(){
        ...
        btnSelesai.putClientProperty(FlatClientProperties.STYLE, ""
                + "foreground:@accentColor;"
                + "background:rgb(255,255,255);");
        btnSelesai.setIcon(new FlatSVGIcon("com/radja/icon/edit.svg", 0.4f));
        btnSelesai.setIconTextGap(5);
        btnSelesai.addActionListener((e) -> updateData());
...
private void searchData() {
    ...
    if (row != -1) {
        ...
        String message = "Are you sure the vehicle with plate " + noPlat + " will be marked as having completed the washing process?";
        ...
        ModalDialog.showModal(this, new MessageModal(MessageModal.Type.INFO, message, title, SimpleModalBorder.YES_NO_OPTION,
            (controller, action) -> {
                if (action == SimpleModalBorder.YES_OPTION) {
                    ...
                    Toast.show(this, Toast.Type.SUCCESS, "Data has been successfully marked as completed.", getOptionAlert());
                    loadData();
                }
            }), option);
    } else {
        Toast.show(this, Toast.Type.INFO, "Please select the data you want to mark as completed", getOptionAlert());
    }
}
