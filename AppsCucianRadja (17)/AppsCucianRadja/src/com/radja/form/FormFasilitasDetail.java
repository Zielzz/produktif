...
import com.radja.tablemodel.TabModFasilitasDetail;
...
public class FormFasilitasDetail extends JPanel{

    private final TabModFasilitasDetail tblModel = new TabModFasilitasDetail();
    private final ServiceFasilitasDetail servis = new FasilitasDetailDAO();
    ...
    public FormFasilitasDetail(int idFasilitas) {
        init();
        this.idFasilitas = idFasilitas;
        System.out.println(idFasilitas);
        loadData();
    }
    ...
    private void loadData(){
        List<FasilitasDetail> list = servis.getData(idFasilitas);
    ...
    private void searchData(){
        ...
        List<FasilitasDetail> list = servis.searchData(idFasilitas, keyword);
        tblModel.setData(list);
        tblData.setModel(tblModel);
    }
}
