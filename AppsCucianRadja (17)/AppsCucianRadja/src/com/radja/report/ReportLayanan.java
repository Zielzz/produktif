...
public class ReportLayanan extends Form{
    ...
    private JPanel setInfo(){
        ...
        JLabel lbTitle = new JLabel("Laporan Data Layanan");
    ...
    private JPanel setButton(){
        ...
        btnPrint.addActionListener((e) -> servisReport.printLayanan());
        ...
        btnExportPDF.addActionListener((e) -> servisReport.saveLayananPDF());
        ...
        btnExportCSV.addActionListener((e) -> servisReport.saveLayananExcel());
    ...
    private void loadData(){
        List<LayananDetail> list = servis.getDataReport("FALSE");
    ...
    private void searchData(){
        ...
        List<LayananDetail> list = servis.searchDataReport(keyword, "FALSE");
        tblModel.setData(list);
        tblData.setModel(tblModel);
    }
}
